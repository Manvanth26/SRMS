<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content">
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li>
                                        <a href="dashboard.php"><i class="fa fa-dashboard"></i> <span>Admin Home</span> </a>
                                    ...
                                    <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            ...
                                            <li><a href="manage-classes.php"><i class="fa fa fa-server"></i> <span>Manage Branch</span></a></li>
  ...
  <li class="has-children">
   ...
   <li class="has-children">
                                    ...
                                    <!--<li class="has-children">
                                        <a href="#"><i class="fa fa-file-text"></i> <span>Staff</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
